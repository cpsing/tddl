...
public class TGroupPreparedStatement extends TGroupStatement implements TPreparedStatement {
    ...
    protected void fillSqlMetaData(PreparedStatement ps, String sql) {
        if (ps instanceof TPreparedStatement) fillSqlMetaData((TPreparedStatement) ps, sql);
    }

    /**
     * 往TPreparedStatement里注入sql元信息
     * 
     * @param ps
     */
    protected void fillSqlMetaData(TPreparedStatement ps, String sql) {
        if (this.sqlMetaData == null) {
            this.sqlMetaData = SqlMetaDataFactory.getSqlMetaData(sql);
        }
        ps.fillMetaData(this.sqlMetaData);
    }
