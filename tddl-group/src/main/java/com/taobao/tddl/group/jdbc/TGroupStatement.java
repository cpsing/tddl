...
public class TGroupStatement implements TStatement {
    ...
    private Statement createStatementInternal(Connection conn, String sql, boolean isBatch) throws SQLException {
        Statement stmt;
        if (isBatch) stmt = conn.createStatement();
        else {
    ...
    public int[] executeBatch() throws SQLException {
        try {
            ...
            if (batchedArgs != null) batchedArgs.clear();
        }
    }
    ...
    void close(boolean removeThis) throws SQLException {
        ...
        try {
            if (this.baseStatement != null) this.baseStatement.close();
        } finally {
            this.baseStatement = null;
            if (removeThis) tGroupConnection.removeOpenedStatements(this);
        }
    }
    ...
    public ResultSet getGeneratedKeys() throws SQLException {
        if (this.baseStatement != null) return this.baseStatement.getGeneratedKeys();
        else throw new SQLException("在调用getGeneratedKeys前未执行过任何更新操作");
