    ...
    public void testNotAutoCommitOnDifferentGroup() throws Exception {
...

        {
            try {
                ...
                Assert.assertEquals("com.taobao.tddl.common.exception.TddlException: com.taobao.tddl.common.exception.TddlRuntimeException: transaction across group is not supported",
                    ex.getMessage());
            }
        }
