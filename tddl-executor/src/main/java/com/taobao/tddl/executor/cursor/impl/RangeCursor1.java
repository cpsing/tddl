 ...
 */
public class RangeCursor1 extends SchematicCursor implements IRangeCursor {

    public static final Logger    log          = LoggerFactory.getLogger(RangeCursor1.class);
    /**
     * 范围，到哪里结束
     */
    ...
    public RangeCursor1(ISchematicCursor cursor, IFilter lf){
